    ...
    public synchronized Object[][] dateData() {
        if (dateCache == null) {
            dateCache = new Object[][]{
                ...
                new Object[]{24L, LocalDateTime.now(), OffsetDateTime.now().withOffsetSameLocal(ZoneOffset.MAX), ZonedDateTime.now().withZoneSameLocal(ZoneId.of("GMT+20"))},
                new Object[]{25L, LocalDateTime.now(), OffsetDateTime.now().withOffsetSameInstant(ZoneOffset.MIN), ZonedDateTime.now().withZoneSameInstant(ZoneId.of("GMT-22"))}
            };
        }
        return dateCache;
    }
